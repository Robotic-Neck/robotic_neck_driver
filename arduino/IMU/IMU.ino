...
void loop() {
  ...
  if (AccX !=0 || AccZ != 0) { // for zero error
  ...
  if (AccY !=0 || AccZ != 0) { // for zero error
  ...
  gyroAngleX = (GyroX/131.0) - GyroErrorX; // GyroErrorX ~(-0.56)
  gyroAngleY = (GyroY/131.0) - GyroErrorY; // GyroErrorY ~(2)
  //GyroZ = GyroZ/ 131.0 - GyroErrorZ; // GyroErrorZ ~ (-0.8)
